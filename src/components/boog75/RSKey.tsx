...
//alert(props.keyindex)
    ...
    const handleDrop = (e: any) => {
        ...
        const keyIndex = e.dataTransfer.getData('keyindex')
        const isRSaction = e.dataTransfer.getData('isRSaction')
        const oldkeyindex = e.dataTransfer.getData('oldkeyindex')
        //(oldkeyindex)
       // alert(keyIndex)
        props.onChangeKey({ vkCode: vkCode, keyText: keyText,keyIndex:parseInt(keyIndex),isRSaction:isRSaction})
